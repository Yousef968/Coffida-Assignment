      ...
      <NavigationContainer>
        <Stack.Navigator>
          ...
          <Stack.Screen
            ...
            options={{title: 'Update first name'}}
          />
          <Stack.Screen
            name="update last name"
            component={updateLname}
            options={{title: 'Update last name'}}
          />
          <Stack.Screen
            name="update email"
          ...
          <Stack.Screen
            ...
            options={{title: 'Find locations'}}
          />
          <Stack.Screen
            name="getSingleLocation"
            component={getSingleLocation}
            options={{title: 'Get a single location'}}
          />
          <Stack.Screen
            name="Search"
            component={Search}
          ...
          <Stack.Screen
            ...
            options={{title: 'Locations and Reviews'}}
          />
          <Stack.Screen
            name="HandleReviews"
            component={HandleReviews}
            options={{title: 'Locations and Reviews'}}
          />
          <Stack.Screen
            name="usersReviews"
          ...
          <Stack.Screen
            name="favLocations"
            component={favLocations}
            options={{title: 'Favourite locations'}}
          />
          <Stack.Screen
            name="updateOverallrating"
            component={updateOverallrating}
            options={{title: 'Update overall rating'}}
          />
          <Stack.Screen
            name="updatePricerating"
            component={updatePricerating}
            options={{title: 'Update price rating'}}
          />
          <Stack.Screen
            name="updateQualityrating"
            component={updateQualityrating}
            options={{title: 'Update quality rating'}}
          />
          <Stack.Screen
            name="updateClenrating"
            component={updateClenrating}
            options={{title: 'Update cleanliness rating'}}
          />
          <Stack.Screen
            name="updateRevbody"
            component={updateRevbody}
            options={{title: 'Update review body'}}
          />
          <Stack.Screen
            name="HandlePhotos"
            component={HandlePhotos}
            options={{title: 'Photo'}}
          />
          <Stack.Screen
            name="favLocationReviews"
            component={favLocationReviews}
            options={{title: 'Reviews'}}
          />
          <Stack.Screen
            name="likeRevs"
            component={likeRevs}
            options={{title: 'Like/Unlike review'}}
          />
          <Stack.Screen
            name="likedreviews"
            component={likedreviews}
            options={{title: 'Liked reviews'}}
          />
          <Stack.Screen
            name="SearchResults"
          ...
          />
          <Stack.Screen
            name="FavouriteALocation"
            component={FavouriteALocation}
            options={{title: 'Favourite a location'}}
          />
          <Stack.Screen
            name="viewPhoto"
